!function(a, b) {
    ...
    var s = function(a) {
        ...
        for (b in {
            ...
            d.pseudos[b] = mb(b);
        return pb.prototype = d.filters = d.pseudos,
        d.setFilters = new pb,
            ...
            for (var e, f, g, h, i, j, l, n = a.length, o = db(b), p = [], q = 0; n > q; q++)
                ...
                f || 0 === f)
                    if ("object" === m.type(f))
                        ...
                        !k.tbody)
                            for (f = "table" !== i || kb.test(f) ? "<table>" !== l[1] || kb.test(f) ? 0 : h : h.firstChild,
    ...
    m.extend({
        ...
        prop: function(a, b, c) {
            ...
            return a && 3 !== g && 8 !== g && 2 !== g ? (f = 1 !== g || !m.isXMLDoc(a),
            f && (b = m.propFix[b] || b,
            e = m.propHooks[b]),
    ...
    m.fn.extend({
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var a = this.offsetParent || cd; a && !m.nodeName(a, "html") && "static" === m.css(a, "position"); )
                    a = a.offsetParent;
                return a || cd
            })
        }
...
function(e) {
    ...
    e.extend(n.prototype, {
        ...
        parseDate: function(t, i, s) {
            ...
            y > -1)
                for (g = 1,
                v = y; a = this._getDaysInMonth(m, g - 1),
                !(a >= v); )
                    g++,
                    v -= a;
        ...
        _generateHTML: function(e) {
            ...
            w = 0; V[0] > w; w++) {
                ...
                T = 0; V[1] > T; T++) {
                    ...
                    I = Math.ceil((A + P) / 7),
                    z = G && this.maxRows > I ? this.maxRows : I,
                    this.maxRows = z,
...
!function(root, doc, factory) {
    ...
    !function($, window, document, undefined) {
        ...
        function createVirtualEvent(event, eventType) {
            ...
            -1 !== t.search(/^touch/) && (ne = getNativeEvent(oe),
            t = ne.touches,
            ct = ne.changedTouches,
            touch = t && t.length ? t[0] : ct && ct.length ? ct[0] : undefined))
                for (j = 0,
                len = touchEventProps.length; len > j; j++)
        ...
        function getClosestElementWithVirtualBinding(element, eventType) {
            for (var b; element; ) {
                if (b = $.data(element, dataPropertyName),
        ...
        function triggerVirtualEvent(eventType, event, flags) {
            var ve;
            return (flags && flags[eventType] || !flags && getClosestElementWithVirtualBinding(event.target, eventType)) && (ve = createVirtualEvent(event, eventType),
            $(event.target).trigger(ve)),
            ve
        }
        function mouseEventCallback(event) {
            var ve, touchID = $.data(event.target, touchTargetPropertyName);
            blockMouseTriggers || lastTouchID && lastTouchID === touchID || (ve = triggerVirtualEvent("v" + event.type, event),
            ve && (ve.isDefaultPrevented() && event.preventDefault(),
        ...
        function handleTouchStart(event) {
            ...
            touches && 1 === touches.length && (target = event.target,
            flags = getVirtualBindingFlags(target),
            flags.hasVirtualBinding && (lastTouchID = nextTouchID++,
        ...
        function handleTouchMove(event) {
            if (!blockTouchTriggers) {
                ...
                didScroll && !didCancel && triggerVirtualEvent("vmousecancel", event, flags),
        ...
        function handleTouchEnd(event) {
            if (!blockTouchTriggers) {
                ...
                didScroll || (ve = triggerVirtualEvent("vclick", event, flags),
                ve && ve.isDefaultPrevented() && (t = getNativeEvent(event).changedTouches[0],
                clickBlockList.push({
                    touchID: lastTouchID,
                    x: t.clientX,
                    y: t.clientY
        ...
        eventCaptureSupported && document.addEventListener("click", function(e) {
            var x, y, ele, i, o, touchID, cnt = clickBlockList.length, target = e.target;
            if (cnt)
                for (x = e.clientX,
                y = e.clientY,
                ...
                context.start = function(event) {
                    if (!$.event.special.swipe.eventInProgress) {
                        ...
                        context.move = function(event) {
                            start && (stop = $.event.special.swipe.stop(event),
                            emitted || (emitted = $.event.special.swipe.handleSwipe(start, stop, thisObject, origTarget),
                            emitted && ($.event.special.swipe.eventInProgress = !1)),
        ...
        if (j.crossDomain && j.async && o.test(j.type) && n.test(j.url) && p.test(j.url)) {
            ...
            return {
                send: function(f, g) {
                    ...
                    /^\d+$/.test(k.timeout) && (m.timeout = k.timeout),
                    ...
                    m.onload = function() {
                        ...
                        try {
                            if ("html" === i || /text\/html/i.test(m.contentType))
                                c.html = m.responseText;
                            else if ("json" === i || "text" !== i && /\/json/i.test(m.contentType))
                                try {
                    ...
                    ,
                    k.data && (h = "string" === $.type(k.data) ? k.data : $.param(k.data)),
                    m.open(j.type, j.url),
                    m.send(h)
                },
                abort: function() {
...
window.self === window.top && (window.localStorage || (window.localStorage = {
    getItem: function(e) {
...
window.sessionStorage || (window.sessionStorage = {
    ...
    setItem: function(e, t) {
        e && (document.cookie = escape(e) + "=" + escape(t) + "; path=/",
        this.length = document.cookie.match(/\=/g).length)
    },
    length: 0,
    removeItem: function(e) {
...
var _slicedToArray = function() {
    function r(r, n) {
        var t = []
          ...
          , i = void 0;
        try {
            for (var u, l = r[Symbol.iterator](); !(e = (u = l.next()).done) && (t.push(u.value),
            !n || t.length !== n); e = !0)
                ;
        } catch (a) {
            o = !0,
...
!function(r) {
    var n = /\[([^\]]*)\]/gi
      ...
      , e = function(r, n, t) {
        if (!r[n])
            return !0;
        for (var e = r[n], o = 0, i = t.length; i > o; o++)
            if (e = e[t[o]],
            !e)
                return !0;
        return !1
      ...
      , i = function(r) {
        return "number" == typeof r || "string" == typeof r || "boolean" == typeof r
    }
      , u = function h(r, n, t, o) {
        var i, u, l;
        return 0 === t.length ? void (0 === n.length ? r.push(o) : r[n] = o) : (u = t.shift(),
        l = null,
        0 === n.length && 0 === u.length ? (r[r.length - 1] && _.isArray(r[r.length - 1]) || r.push([]),
        l = r[r.length - 1]) : 0 === n.length && u.length > 0 ? ((0 === r.length || _.isArray(r[r.length - 1]) || "object" != typeof r[r.length - 1]) && r.push({}),
        i = r[r.length - 1],
        e(i, u, t) || r.push({}),
        i = r[r.length - 1],
        l = i) : n.length > 0 && 0 === u.length ? (r[n] || (r[n] = []),
        l = r[n]) : n.length > 0 && u.length > 0 && (r[n] || (r[n] = {}),
        l = r[n]),
        void h(l, u, t, o))
    }
      , l = function() {
        for (var r = arguments.length <= 0 || void 0 === arguments[0] ? window.location.search : arguments[0], e = r.split(/[?&;] */), o = {}, i = 0, l = e.length; l > i; i++) {
            var a = e[i];
            if (a.length >= 0) {
                var f = _.map(a.split("="), function(r) {
                    return decodeURIComponent(r)
                })
                  , h = _slicedToArray(f, 2)
                  , g = h[0]
                  , s = h[1];
                if (void 0 !== g && void 0 !== s) {
                    for (var c = [], y = void 0; y = n.exec(g); )
                        c.push(y[1]);
                    var p = t.exec(g)[1];
                    u(o, p, c, s)
                }
      ...
      , a = function(r, n) {
        var t = f(r, "", !0);
        return n && n.questionMark && t.length > 0 && (t = "?" + t),
        t
    }
      , f = function g(r, n, t) {
        var e, u, l, a, f, h, s, c;
    ...
    r.querify = a,
    r.stringify = a
}("undefined" != typeof exports && null != exports ? exports : window),
!function(a, b) {
    function c(a, b, c) {
        return d.yubl(b((c || d.yufull)(a)))
    }
    b.xssFilters = a,
    a._getPrivFilters = function() {
        function a(a) {
            return a = a.split(x, 2),
            2 === a.length && a[0] ? a[0] : null
        }
        function b(a, b, c, d) {
            function e(a, c, e, g) {
                return c ? (c = Number(c[0] <= "9" ? c : "0" + c),
                d ? B(c) : 128 === c ? "�" : 130 === c ? "�" : 131 === c ? "�" : 132 === c ? "�" : 133 === c ? "�" : 134 === c ? "�" : 135 === c ? "�" : 136 === c ? "�" : 137 === c ? "�" : 138 === c ? "�" : 139 === c ? "�" : 140 === c ? "�" : 142 === c ? "�" : 145 === c ? "�" : 146 === c ? "�" : 147 === c ? "�" : 148 === c ? "�" : 149 === c ? "�" : 150 === c ? "�" : 151 === c ? "�" : 152 === c ? "�" : 153 === c ? "�" : 154 === c ? "�" : 155 === c ? "�" : 156 === c ? "�" : 158 === c ? "�" : 159 === c ? "�" : c >= 55296 && 57343 >= c || 13 === c ? "?" : f.frCoPt(c)) : b[e || g] || a
            }
            return b = b || p,
            c = c || o,
            void 0 === a ? "undefined" : null === a ? "null" : a.toString().replace(k, "?").replace(c, e)
        }
        function c(a) {
            return "\\" + a.charCodeAt(0).toString(16).toLowerCase() + " "
        }
        function d(a) {
        ...
        var f, g = /</g, h = /"/g, i = /'/g, j = /&/g, k = /\x00/g, l = /(?:^$|[\x00\x09-\x0D "'`=<>])/g, m = /[&<>"'`]/g, n = /(?:\x00|^-*!?>|--!?>|--?!?$|\]>|\]$)/g, o = /&(?:#([xX][0-9A-Fa-f]+|\d+);?|(Tab|NewLine|colon|semi|lpar|rpar|apos|sol|comma|excl|ast|midast|ensp|emsp|thinsp);|(nbsp|amp|AMP|lt|LT|gt|GT|quot|QUOT);?)/g, p = {
            Tab: "	",
            NewLine: "\n",
            colon: ":",
            semi: ";",
            ...
            quot: '"',
            QUOT: '"'
        }, q = /^(?:(?!-*expression)#?[-\w]+|[+-]?(?:\d+|\d*\.\d+)(?:r?em|ex|ch|cm|mm|in|px|pt|pc|%|vh|vw|vmin|vmax)?|!important|)$/i, r = /[\x00-\x1F\x7F\[\]{}\\"]/g, s = /[\x00-\x1F\x7F\[\]{}\\']/g, t = /url[\(\u207D\u208D]+/g, u = /['\(\)]/g, v = /\/\/%5[Bb]([A-Fa-f0-9:]+)%5[Dd]/, w = {
            javascript: 1,
            data: 1,
            vbscript: 1,
            mhtml: 1,
            "x-schema": 1
        }, x = /(?::|&#[xX]0*3[aA];?|&#0*58;?|&colon;)/, y = /(?:^[\x00-\x20]+|[\t\n\r\x00]+)/g, z = {
            Tab: "	",
            NewLine: "\n"
        }, A = function(a, b, c) {
            return void 0 === a ? "undefined" : null === a ? "null" : a.toString().replace(b, c)
        }, B = String.fromCodePoint || function(a) {
            return 0 === arguments.length ? "" : 65535 >= a ? String.fromCharCode(a) : (a -= 65536,
            String.fromCharCode((a >> 10) + 55296, a % 1024 + 56320))
        }
        ;
        return f = {
            frCoPt: function(a) {
                return void 0 === a || null === a ? "" : !isFinite(a = Number(a)) || 0 >= a || a > 1114111 || a >= 1 && 8 >= a || a >= 14 && 31 >= a || a >= 127 && 159 >= a || a >= 64976 && 65007 >= a || 11 === a || 65535 === (65535 & a) || 65534 === (65535 & a) ? "?" : B(a)
            },
            d: b,
            yup: function(c) {
                return c = a(c.replace(k, "")),
                c ? b(c, z, null, !0).replace(y, "").toLowerCase() : null
            },
            y: function(a) {
            ...
            yc: function(a) {
                return A(a, n, function(a) {
                    return "\x00" === a ? "?" : "--!" === a || "--" === a || "-" === a || "]" === a ? a + " " : a.slice(0, -1) + " >"
                })
            },
            yavd: function(a) {
                return A(a, h, "&quot;")
            ...
            yufull: function(a) {
                return f.yu(a).replace(v, function(a, b) {
                    return "//[" + b + "]"
                })
            },
            yublf: function(a) {
            ...
            yceu: function(a) {
                return a = b(a),
                q.test(a) ? a : ";-x:'" + d(a.replace(s, c)) + "';-v:"
            },
            yced: function(a) {
                return d(b(a).replace(r, c))
            },
            yces: function(a) {
                return d(b(a).replace(s, c))
            },
            yceuu: function(a) {
                return e(a).replace(u, function(a) {
                    return "'" === a ? "\\27 " : "(" === a ? "%28" : "%29"
                })
            },
            yceud: function(a) {
            ...
            yceus: function(a) {
                return e(a).replace(i, "\\27 ")
            }
        }
    }
    ;
    var d = a._privFilters = a._getPrivFilters();
    a.inHTMLData = d.yd,
    a.inHTMLComment = d.yc,
    a.inSingleQuotedAttr = d.yavs,
    a.inDoubleQuotedAttr = d.yavd,
    a.inUnQuotedAttr = d.yavu,
    a.uriInSingleQuotedAttr = function(a) {
        return c(a, d.yavs)
    }
    ,
    a.uriInDoubleQuotedAttr = function(a) {
        return c(a, d.yavd)
    }
    ,
    a.uriInUnQuotedAttr = function(a) {
        return c(a, d.yavu)
    }
    ,
    a.uriInHTMLData = d.yufull,
    a.uriInHTMLComment = function(a) {
        return d.yc(d.yufull(a))
    }
    ,
    a.uriPathInSingleQuotedAttr = function(a) {
        return c(a, d.yavs, d.yu)
    }
    ,
    a.uriPathInDoubleQuotedAttr = function(a) {
        return c(a, d.yavd, d.yu)
    }
    ,
    a.uriPathInUnQuotedAttr = function(a) {
        return c(a, d.yavu, d.yu)
    }
    ,
    a.uriPathInHTMLData = d.yu,
    a.uriPathInHTMLComment = function(a) {
        return d.yc(d.yu(a))
    }
    ,
    a.uriQueryInSingleQuotedAttr = a.uriPathInSingleQuotedAttr,
    a.uriQueryInDoubleQuotedAttr = a.uriPathInDoubleQuotedAttr,
    a.uriQueryInUnQuotedAttr = a.uriPathInUnQuotedAttr,
    a.uriQueryInHTMLData = a.uriPathInHTMLData,
    a.uriQueryInHTMLComment = a.uriPathInHTMLComment,
    a.uriComponentInSingleQuotedAttr = function(a) {
        return d.yavs(d.yuc(a))
    }
    ,
    a.uriComponentInDoubleQuotedAttr = function(a) {
        return d.yavd(d.yuc(a))
    }
    ,
    a.uriComponentInUnQuotedAttr = function(a) {
        return d.yavu(d.yuc(a))
    }
    ,
    a.uriComponentInHTMLData = d.yuc,
    a.uriComponentInHTMLComment = function(a) {
        return d.yc(d.yuc(a))
    }
    ,
    a.uriFragmentInSingleQuotedAttr = function(a) {
        return d.yubl(d.yavs(d.yuc(a)))
    }
    ,
    a.uriFragmentInDoubleQuotedAttr = function(a) {
        return d.yubl(d.yavd(d.yuc(a)))
    }
    ,
    a.uriFragmentInUnQuotedAttr = function(a) {
        return d.yubl(d.yavu(d.yuc(a)))
    }
    ,
    a.uriFragmentInHTMLData = a.uriComponentInHTMLData,
    a.uriFragmentInHTMLComment = a.uriComponentInHTMLComment
}({}, function() {
    return this
}()),
...
Array.prototype.find || Object.defineProperty(Array.prototype, "find", {
    value: function(predicate) {
        ...
        for (var thisArg = arguments[1], k = 0; len > k; ) {
            var kValue = o[k];
...
Array.prototype.forEach || (Array.prototype.forEach = function(callback, thisArg) {
    ...
    for (arguments.length >= 2 && (T = thisArg),
    k = 0; len > k; )
        k in O && (kValue = O[k],
...
function($) {
    var v = {}
      ...
      , controlVar = function(a) {
        for (n in a)
            "undefined" == typeof a[n] && console.trace("Variable necesaria")
    }
      , calculoHeight = function() {
        return "undefined" != typeof v.windowHeight ? v.windowHeight : (v.windowHeight = $(window).innerHeight(),
      ...
      , posiScroll = function() {
        return "undefined" != typeof v.posiScroll ? v.posiScroll : (v.posiScroll = $(window).scrollTop(),
        $(window).scroll(function() {
            v.posiScroll = $(window).scrollTop()
        }),
        v.posiScroll)
    };
    $.fn.hotusa = function() {
        var functions = {
            animate: function(obj) {
                if (controlVar([obj.elem, obj.draw]),
                obj.timing = "function" != typeof obj.timing ? function(t) {
                    return t
                }
                : obj.timing,
                obj.duration = "number" != typeof obj.duration ? 1e3 : obj.duration,
                obj.callback = "function" != typeof obj.callback ? f : obj.callback,
                0 === obj.duration)
                    return obj.callback(),
                    !1;
                v.animate || (v.animate = []);
                ...
                _tmp.id = requestAnimationFrame(function animate(time) {
                    ...
                    if (obj.draw(progreso),
                    1 > tf && !_tmp.end && requestAnimationFrame(animate),
                    progreso >= 1) {
                        _tmp.end = !0,
                        obj.callback();
                        var _r = v.animate.indexOf(_tmp);
                        _r >= 0 && v.animate.splice(_r, 1)
                    }
                })
            },
            ajax: function(param) {
                ...
                "string" != typeof param.data && param.data instanceof FormData == !1 && (param.data = JSON.stringify(param.data)),
                ...
                param.header !== !1 && request.setRequestHeader("Content-Type", param.header),
            ...
            animateStop: function(elem) {
                ...
                !v.animate)
                    return !1;
                var search = v.animate.find(function(e) {
                    return e.elem === elem && !e.end
                });
                if (!search)
                    return !1;
                ...
                return _r >= 0 && v.animate.splice(_r, 1),
                !0
            },
            dimensionImg: function() {
                v.dimensionImg = {},
                v.dimensionImg.anchosArr = {
                    100: {
                        w: 150,
                        h: 113
                    },
                ...
                var anchos = function(w, h) {
                    switch (w = Math.max(w, h / 3 * 4),
                    !0) {
                    case w >= 1250:
                        return v.dimensionImg.anchosArr[1500];
                    case w >= 950:
                        return v.dimensionImg.anchosArr[1250];
                    case w >= 550:
                        return v.dimensionImg.anchosArr[900];
                    case w >= 350:
                        return v.dimensionImg.anchosArr[550];
                    case w >= 250:
                        return v.dimensionImg.anchosArr[350];
                    case w >= 200:
                        return v.dimensionImg.anchosArr[250];
                    case w >= 100:
                        return v.dimensionImg.anchosArr[200];
                    default:
                        return v.dimensionImg.anchosArr[100]
                    }
                }
                  , defaultCont = function() {
                    return v.dimensionImg.defaultEnd ? v.dimensionImg.defaultEnd : (v.dimensionImg.defaultEnd = anchos(window.innerWidth, window.innerHeight),
                    v.dimensionImg.defaultEnd)
                }
                  , fn = function(elem) {
                    return elem ? anchos(elem.offsetWidth, elem.offsetHeight) : defaultCont()
                };
                return fn
            }(),
            cargaScrollAuto: function(param, fn) {
                ...
                var _fn = function() {
                    ...
                    return _s <= alturaW + posScroll + param.before && !param.dual || _s + param.$obj.innerHeight() >= posScroll - param.before && _s <= alturaW + posScroll + param.before ? ($(window).off("scroll", _fn),
                    $(window).off("resize", _fn),
                    fn(),
                    !0) : !1
                };
                _fn() || (param.overflow ? ($(param.overflow).on("scroll", _fn),
                $(param.overflow).on("resize", _fn)) : ($(window).on("scroll", _fn),
                $(window).on("resize", _fn)))
            },
            cargarFicheroCSS: function(url, fn) {
                if (controlVar([url]),
                v.JSON_ficherosCSS_end || (v.JSON_ficherosCSS_end = []),
                v.JSON_ficherosCSS_load || (v.JSON_ficherosCSS_load = []),
                v.JSON_ficherosCSS_feed || (v.JSON_ficherosCSS_feed = []),
                v.JSON_ficherosCSS_end.indexOf(url) < 0)
                    if (v.JSON_ficherosCSS_load.indexOf(url) >= 0) {
                        ...
                        link.addEventListener("load", function() {
                            ...
                            for (var _t = v.JSON_ficherosCSS_feed.filter(function(e) {
                                return e.url == url
                            }), i = 0; i < _t.length; i++)
                                _t[i].f()
                        }, !1)
            ...
            cargarFicheroJS: function(url, fn) {
                if (controlVar([url]),
                fn = "undefined" != typeof fn ? fn : f,
                v.JSON_ficherosJS_end || (v.JSON_ficherosJS_end = []),
                v.JSON_ficherosJS_load || (v.JSON_ficherosJS_load = []),
                v.JSON_ficherosJS_feed || (v.JSON_ficherosJS_feed = []),
                v.JSON_ficherosJS_end.indexOf(url) < 0)
                    if (v.JSON_ficherosJS_load.indexOf(url) >= 0) {
                        ...
                        $.ajax({
                            ...
                            success: function() {
                                ...
                                fn();
                                for (var _t = v.JSON_ficherosJS_feed.filter(function(e) {
                                    return e.url == url
                                }), i = 0; i < _t.length; i++)
                                    _t[i].f()
                            }
            ...
            cargarJSON: function(url, param, fn) {
                ...
                v.JSON_cargados || (v.JSON_cargados = {}),
                v.JSON_paraCargar || (v.JSON_paraCargar = []),
                v.cargaPendiente || (v.cargaPendiente = []);
                var dParam = {
                    asinc: !0,
                    update: !1
                };
                if ("function" == typeof param ? (fn = param,
                param = dParam) : param = Object.assign(dParam, param),
                "function" != typeof fn)
                    return !1;
                if ($.inArray(url, v.JSON_paraCargar) < 0 || $.inArray(url, Object.keys(v.JSON_cargados)) >= 0 || !$.active)
                    $.inArray(url, v.JSON_paraCargar < 0) && v.JSON_paraCargar.push(url),
                    param.update || $.inArray(url, Object.keys(v.JSON_cargados)) < 0 ? $.ajax({
                        url: url,
                        dataType: "json",
                        async: param.asinc,
                        success: function(contenido) {
                            return v.JSON_cargados[url] = contenido,
                        ...
                        if (v.cargaPendiente.length > 0)
                            for (n in v.cargaPendiente)
                                if (v.cargaPendiente[n] && Object.keys(v.cargaPendiente[n])[0] == url) {
                                    var fun = v.cargaPendiente[n][url];
                                    v.cargaPendiente[n] = "",
                                    fun(hotusa().copyObject(v.JSON_cargados[url]))
                                }
                    }) : $.inArray(url, v.JSON_cargados) < 0 && fn(hotusa().copyObject(v.JSON_cargados[url]));
                else {
                    var obj = {};
                    obj[url] = function() {
                        hotusa().cargarJSON(url, param, fn)
                    }
                    ,
            ...
            controlDefecto: function(nObj, obj) {
                return controlVar([nObj]),
                Object.assign(nObj, obj)
            },
            controlTop: function(ele, clase, fn) {
                controlVar([ele]),
                "function" == typeof clase ? (fn = clase,
                clase = "sta-fixed") : (clase = "undefined" != typeof clase ? clase : "sta-fixed",
                fn = "undefined" != typeof fn ? fn : f),
                ele = $(ele);
                var a = function() {
                    $(window).scrollTop() > ele.offset().top ? ele.hasClass(clase) || (ele.addClass(clase),
                    fn(!0)) : ele.hasClass(clase) && (ele.removeClass(clase),
                    fn(!1))
                };
                a(),
                $(window).scroll(a)
            ...
            copyObject: function(obj) {
                if (null === obj || void 0 === obj || "object" != typeof obj)
                    return obj;
            ...
            dateValid: function(date) {
                return controlVar([date]),
                /^(((0[1-9]|[12]\d|3[01])\/(0[13578]|1[02])\/((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)\/(0[13456789]|1[012])\/((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])\/02\/((19|[2-9]\d)\d{2}))|(29\/02\/((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$/g.test(date)
            },
            dateControler: function(dFin, dIni) {
                ...
                var json = {
                  ...
                  , dFin = new Date(dFin);
                if (dIni = "string" == typeof dIni ? new Date(dIni) : dIni = new Date,
                dFin > dIni) {
            ...
            iframeYoutube: function(id, param) {
                controlVar([id]);
                var dparam = {
                    "class": "sta-iframeYoutube",
                    type: "text/html",
                    frameborder: "0",
                    allowfullscreen: "true",
                    src: "https://www.youtube.com/embed/" + id
                };
                return param = Object.assign(dparam, param),
                $("<iframe></iframe>", param)
            },
            removeCookie: function(cookie, fn) {
                controlVar([cookie]),
                fn = "undefined" != typeof fn ? fn : f,
                hotusa().setCookie(cookie, "", -100, void 0, fn)
            },
            removeStorage: function(name, fn) {
                controlVar([name]),
                "undefined" != typeof Storage ? localStorage.removeItem(name) : hotusa().removeCookie(name),
                "undefined" != typeof fn && fn()
            },
            removeSessionStorage: function(name, fn) {
                controlVar([name]),
                "undefined" != typeof Storage ? sessionStorage.removeItem(name) : hotusa().removeCookie(name),
                "undefined" != typeof fn && fn()
            },
            ...
            enlace_blank: function(obj, param, fn) {
                ...
                var hr = $(obj).attr("href").trim()
                  , ar = !1;
                v.dm || (v.dm = hotusa().getDomain(document.domain)),
                void 0 != hr && ("/" != hr.slice(0, 1) && "" == hotusa().getDomain(hr) || hr.toLowerCase().indexOf("javascript:") >= 0 || "#" == hr.slice(0, 1) || (param.revisar_archivo && $.inArray(hr.substring(hr.lastIndexOf("."))) >= 0 && (ar = !0),
                param.revisar_target ? "_parent" != $(obj).attr("target") && "_self" != $(obj).attr("target") && "_top" != $(obj).attr("target") && "_blank" != $(obj).attr("target") && (ar ? $(obj).attr("target", "_blank") : "/" !== hr.slice(0, 1) && hotusa().getDomain(hr).split(".")[0] != v.dm.split(".")[0] && $(obj).attr("target", "_blank")) : ar ? $(obj).attr("target", "_blank") : "/" !== hr.slice(0, 1) && hotusa().getDomain(hr).split(".")[0] != v.dm.split(".")[0] && $(obj).attr("target", "_blank"))),
                fn()
            },
            getCookie: function(cookie) {
                controlVar([cookie]);
                for (var n1 = cookie + "=", k1 = decodeURIComponent(document.cookie).split(";"), i1 = 0; i1 < k1.length; i1++) {
                    for (var c1 = k1[i1]; " " == c1.charAt(0); )
                        c1 = c1.substring(1);
                    if (0 == c1.indexOf(n1))
            ...
            getRandom: function(max, min, boo) {
                if (controlVar([max, min]),
                boo = "undefined" != typeof boo ? !0 : boo,
                min > max) {
                    var t = max;
                    max = min,
                    min = t
            ...
            getStorageJSON: function(name) {
                ...
                if ("undefined" != typeof Storage)
                    localStorage[name] && (r = JSON.parse(localStorage[name]));
                else {
            ...
            getSessionStorageJSON: function(name) {
                ...
                var r = !1;
                if ("undefined" != typeof Storage)
                    sessionStorage[name] && (r = JSON.parse(sessionStorage[name]));
                else {
                    var a = hotusa().getCookie(name);
                    a && (r = JSON.parse(a))
                }
            ...
            mail: function(mail) {
                return controlVar([mail]),
                /^(([^<>()\[\]\.,;:\s@\"]+(\.[^<>()\[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i.test(mail)
            },
            replaceAll: function(text, search, replace) {
                for (controlVar([text, search]),
                replace = "undefined" != typeof replace ? replace : ""; -1 != text.toString().indexOf(search); )
                    text = text.toString().replace(search, replace);
                return text
            },
            resizeInterval: function(fn, mS, initial) {
                controlVar(fn),
                initial = "undefined" != typeof initial ? initial : !1,
                mS = "undefined" != typeof mS ? mS : 350;
                var tOut;
                return function() {
                    var c1 = this
                      , a1 = arguments
            ...
            scrollTo: function(id, opt) {
                ...
                opt = "undefined" != typeof opt ? opt : {},
                "function" == typeof opt ? obj.callback = opt : isNaN(opt) ? obj = Object.assign(obj, opt) : obj.tiempo = opt;
                var cuerpo = navigator.userAgent.match(" Safari/") && navigator.userAgent.match(" Version/5.") ? "body" : "html"
                  , n = isNaN(obj.height) ? $(obj.height).outerHeight() : obj.height;
                obj.before(),
                $(cuerpo).animate({
            ...
            setCookie: function(name, value, days, domain, fn) {
                ...
                days = "undefined" != typeof days ? days : 365;
                var d1 = new Date;
                d1.setTime(d1.getTime() + 24 * days * 60 * 60 * 1e3);
                var expires = 0 == days ? "expires=0" : "expires=" + d1.toUTCString()
                  , strCookie = name + "=" + value + ";" + expires + ";path=/";
                domain && (strCookie += ";domain=" + domain),
                document.cookie = strCookie,
                "undefined" != typeof fn && fn()
            },
            setStorageJSON: function(name, obj, fn) {
                controlVar([name, obj]),
                "undefined" != typeof Storage ? localStorage[name] = JSON.stringify(obj) : hotusa().setCookie(name, JSON.stringify(obj)),
                "undefined" != typeof fn && fn()
            },
            setSessionStorageJSON: function(name, obj, fn) {
                controlVar([name, obj]),
                "undefined" != typeof Storage ? sessionStorage[name] = JSON.stringify(obj) : hotusa().setCookie(name, JSON.stringify(obj), 0),
                "undefined" != typeof fn && fn()
            }
        };
        return functions
